...
class Dinosaur:
    ...
    def __init__(self, img=RUNNING[0]):
        ...
        self.rect = pygame.Rect(self.DINO_X, self.DINO_Y, img.get_width(), img.get_height())
        self.step_index = 0
    ...
    def run(self):
        ...
        self.rect.x = self.DINO_X
        self.rect.y = self.DINO_Y
        self.step_index += 1
...
def eval_genomes(genomes, config):
    ...
    def score():
        ...
        points += 1
        if points % 100 == 0 and game_speed < 41:
            game_speed += 1
    ...
    while run:
        ...
        for i, dinosaur in enumerate(dinosaurs):
            ...
            if output[0] > 0.5 and dinosaur.rect.y == dinosaur.DINO_Y:
